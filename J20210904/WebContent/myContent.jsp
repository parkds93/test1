...
<link rel="stylesheet" href="css/mypage/mycontents/mycontent.css" type="text/css">
<!-- Web Font Link-->
...
<div id="body-wrapper">
	...
	<div class="contents">
		...
		<div class="mwContent">
			<div id="mwheadpoint1">
				<div id="mwfont11" align="right">&lt;작성한 글</div>
			</div>
			<div class="mwcontentsboard1">
				<div class="mwupperCont">

					<div id="title11">
						<h1>${board.brd_subject}</h1>
					</div>
					<div id="mwcontrow11">${board.user_id}님</div>
					<c:if test="${not empty pd_name }">
						<div id="mwcontrow11">문의상품 : ${pd_name}</div>
					</c:if>
					<div id="mwcontrow11">${board.brd_reg_date}</div>
				</div>

				<div class="mwlowerCont">
					<div id="mwcontext1">${board.brd_context}</div>
					<div>
						<h3>
							<a href="myWriting.do?pageNum">${board.user_id}님의 게시글 더 보기 </a>
						</h3>
					</div>
				</div>
			</div>
