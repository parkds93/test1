...
<link rel="stylesheet" href="css/login/findPw.css" type="text/css">
<!-- Web Font Link -->
		...
		<div class="container">
			<div class="find-section">
				<h2>비밀번호 찾기</h2>
					...
					<input type="text" name="id" class="id-section" maxlength="10" placeholder="아이디를 입력하세요.">
				...
				<div class="btn">
					<input type="button" value="아이디찾기" class="btn1" onclick="location.href='findIdForm.jsp'">
					<input type="button" value="비밀번호찾기" class="btn2">
				</div>
			</div>
		</div>
	</form>
