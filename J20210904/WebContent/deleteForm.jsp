...
<link rel="stylesheet" href="css/mypage/userdelete/userdelete.css" type="text/css">
<!-- Font Link-->
		...
		<div align="center">
			<form action="deletePro.do" method="post">
				<div class="deletesquare1" align="center">
					<div id="deletetext1">
						<h2>회원탈퇴를 위해 <p> 비밀번호를 입력해 주세요.</h2>
					</div>
					<p>
					<div id="deletetext1">
						<h3>
					...
					<p>
					<div id="deletetext2">
						<input id="btn33" type="submit" value="확인">
						<button id="btn33" type="button"
							onclick="location.href='personalInfo.do'">돌아가기</button>
					</div>
				</div>
			</form>
		</div>
